...
import { type Responsable, type Column, type EvaluatorBase, type ResponsableEdit } from "../types";
...
export function ResponsablesList({ data, columns, onDelete, onEdit, editActive }: ResponsablesListProps) {
